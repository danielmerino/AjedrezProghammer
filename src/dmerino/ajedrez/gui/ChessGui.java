...
import dmerino.ajedrez.logic.IPlayerHandler;
import dmerino.ajedrez.logic.Move;
import dmerino.ajedrez.logic.MoveValidator;
...
public class ChessGui extends JPanel implements IPlayerHandler{
	...
	public ChessGui(ChessGame chessGame) {
		...
		// background
		URL urlBackgroundImg = getClass().getResource("/dmerino/ajedrez/gui/img/bo.png");
	...
	private Image getImageForPiece(int color, int type) {
		...
		URL urlPieceImg = getClass().getResource("/dmerino/ajedrez/gui/img/" + filename);
